export const projects = [
  ...
  {
    title: 'News AI',
    description:"News AI worked Backed by Alan AI where a news is Read aloud from any news Source or the internet Influencer or technology or domain ",
    image: '/images/2.png',
  ...
  },
  {
    ...
    description: "A Hackathon gig where me and my team-mates built the platform for Conducting online HAckathons inside a university and conducting code reviews for freshman and sophmore coders",
      image: '/images/3.png',
  ...
  {
    title: 'EmailSender',
    description: "An application where you can send email across system and platforms. This is a simple application which you can merge in with complex web-application.",
    image: '/images/4.jpg',
    tags: ['Express', 'Nodejs'],
